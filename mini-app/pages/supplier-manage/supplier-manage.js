...
Page({
  ...
  showAdd() {
    this.setData({ editingId: null, dialogTitle: '新增进货商', form: { name: '', contact_name: '', phone: '', remark: '' }, showDialog: true })
  },
  showEdit(e) {
    const s = e.currentTarget.dataset.supplier
    this.setData({ editingId: s.id, dialogTitle: '编辑进货商', form: { name: s.name, contact_name: s.contact_name || '', phone: s.phone || '', remark: s.remark || '' }, showDialog: true })
  },
